      ...
      <div class="${!0===d?"popup-wrapper":""}">
        <div id="popup" class="popup-inner" @click="${t=>this._close(t)}">
          ...
          <div class="range-holder" style="--slider-height: ${u};--slider-width: ${h};">
              <input type="range" style="--slider-width: ${h};--slider-height: ${u}; --slider-border-radius: ${n};--slider-color:${m};--slider-thumb-color:${g};--slider-track-color:${f};" .value="${"off"===e.state?0:Math.round(100*e.attributes.volume_level)}" @change=${t=>this._setVolume(e,t.target.value)}>
          </div>
